...
void K35_WebSrv_init(){
	...
	//g_K35_pWebSrv->onNotFound(not_found_handler);
        //g_K35_pWebSrv->on("/", HTTP_GET, index_page_handler);
        ...
        // g_K35_pWebSrv->on("/defaults", HTTP_GET, set_defaults_handler);
        // g_K35_pWebSrv->on("/get", HTTP_GET, get_handler);
        // g_K35_pWebSrv->on("/restart", HTTP_GET, restart_handler);
