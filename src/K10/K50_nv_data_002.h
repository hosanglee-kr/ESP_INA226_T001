...
OPTIONS_t g_K50_NV_Options; // OPTIONS_t 타입의 전역 변수 선언

#define MODE_READ_WRITE false // 읽기/쓰기 모드
#define MODE_READ_ONLY true    // 읽기 전용 모드

// 함수 프로토타입 선언
void K50_NV_options_store(OPTIONS_t &p_options); // 옵션을 저장하는 함수
void K50_NV_options_load(OPTIONS_t &p_options);  // 옵션을 로드하는 함수
void K50_NV_options_reset(OPTIONS_t &p_options); // 옵션을 초기화하는 함수
void K50_NV_options_print(OPTIONS_t &p_options); // 옵션을 출력하는 함수


// 옵션을 로드하는 함수
void K50_NV_options_load(OPTIONS_t &p_options) {
    // Preferences 시작
...
// 옵션을 출력하는 함수
void K50_NV_options_print(OPTIONS_t &p_options) {
...
// 옵션을 저장하는 함수
void K50_NV_options_store(OPTIONS_t &p_options) {
    g_K50_NV_Prefs.begin("options", MODE_READ_WRITE); // Preferences 시작
